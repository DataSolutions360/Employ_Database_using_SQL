...
select * from public.unique_titles

_______________________________________________________________

--RETIRING TITLES CALCULATIONS
select count(a.emp_no), b.title from public.retirement_titles a
	
	inner join unique_titles b
	on a.emp_no=b.emp_no
	where a.to_date = '9999-01-01'
	group by b.title
	order by count(a.emp_no) desc;
	
	select count(*) from public.mentorship_eligibility;
	----------------------------------------------
